...
////        std::cerr << "True: " << fullBranches << "\n";
////        std::cerr << "False: " << partialBranches << "\n";
...
//        if (vnumber >= 0) {
//          StackFrame &sf = es.stack.back();
//          Cell cell = sf.locals[vnumber];
//          if (cell.value->getKind() == klee::Expr::Constant) {
...
//        // Ako ovaj vektor nema elemenata u pitanju je konstanta
//        if (kgepi->indices.size() > 0) {
//            uint64_t index = kgepi->indices.begin()->first;
