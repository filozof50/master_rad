...
\section{Instalacija i upotreba alata}
...
Takođe, kao izlaz je moguće dobiti i informacije o broju izvršenih instrukcija, utoršenom vremenu, procentu pokrivenosti instrukcija u kodu, procentu pokrivenosti grana u kodu, ukupnom broju LLVM instrukcija koje postoje u bajt kodu i vreme koje je bilo utrošeno za rešavanje ograničenja SMT rešavačem. Ovi podaci se dobijaju komandom \texttt{klee-stats ime\_direktorijuma}, gde \textit{ime\_direktorijuma} predstavlja naziv direktorijuma koji je KLEE kreirao za konkretno izvršavanje.

Primer izlaza za komandu textit{mv} je prikazan na slici \ref{primer_mv}. 

\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{mv_izlaz.png}
    \caption{Izlaz alata KLEE za izvršavanje komande mv GNU Coreutils-a.}
    \label{fig:mv}
\end{figure}
...
% ovo [t] je da budu oba listinga uz vrh strane poravnana ako nisu iste dužine
